function print_today() {
    ...
    return (
        t[e.getMonth()] + " " + n + ", " + ((t = e.getYear()) < 1e3 ? t + 1900 : t)
    );
}
...
function roundNumber(e, t) {
    if ((t = Number(t)) < 1) n = Math.round(e).toString();
        ...
        if (5 <= Number(r.substring(i + 1, i + 2))) {
            if (9 == o && 0 < i)
                for (; 0 < i && (9 == o || isNaN(o));)
                    "." != o ? (--i, (o = Number(r.substring(i, i + 1)))) : --i;
            o += 1;
        }
        n =
            10 == o ?
            ((r = r.substring(0, r.lastIndexOf("."))),
                (Number(r) + 1).toString() + ".") :
            r.substring(0, i) + o.toString();
    } -
    1 == n.lastIndexOf(".") && (n += ".");
    for (
        var a = n.substring(n.lastIndexOf(".") + 1).length, c = 0; c < t - a; c++
    )
        n += "0";
    return n;
}
...
function update_price() {
    var e = $(this).parents(".item-row"),
        t = roundNumber(
            e.find(".cost").val().replace("₹", "") * e.find(".qty").val(),
            2
        );
    isNaN(t) ? e.find(".price").html("N/A") : e.find(".price").html("₹" + t),
        update_total();
}
...
function removeInvoiceRow(e) {
        ...
        function a(e) {
            ...
            return (
                ...
                ("function" == typeof v.getEntriesByType &&
                    (a = v.getEntriesByType("navigation")) &&
                    Array.isArray(a) &&
                    0 < a.length &&
                    ((c.timingsV2 = {}),
                    ...
                    l(i, c.memory)),
                (c.documentWriteIntervention = !!(o = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)) &&
                    ((o = parseInt(o[2], 10)), (e = navigator.connection), 55 <= o) &&
                    !!e &&
                    "cellular" === e.type &&
                    e.downlinkMax <= 0.115),
                ...
                ((a = v.getEntriesByType("resource")),
                    ...
                    a.forEach(function(e) {
                        var e = {
                            ...
                            t =
                            (c.tempResources &&
                                void 0 === c.tempResources[r] &&
                                (c.tempResources[r] = []),
                                JSON.stringify(e).length);
                        n + t < 62e3 && c.tempResources ?
                            ((n += t), c.tempResources[r].push(e)) :
                            (r++, (n = 0));
                    })),
                ...
                (delete c.timings,
                    delete c.memory,
                    delete c.errorCount,
                    delete c.documentWriteIntervention),
                c
            );
        }
        var c,
                ...
                L = function(e) {
                    ...
                    "CLS" === e.name ?
                        ((E.cls = { value: e.value, path: n }),
                            ...
                            ((E.cls.element = R(t.node)),
                                (E.cls.currentRect = t.currentRect),
                                (E.cls.previousRect = t.previousRect))) :
                        "FID" === e.name ?
                        ((E.fid = { value: e.value, path: n }),
                            (t = $(e.entries)) &&
                            ((E.fid.element = R(t.target)), (E.fid.name = t.name))) :
                        "LCP" === e.name &&
                        ((E.lcp = { value: e.value, path: n }), (t = $(e.entries))) &&
                        ((E.lcp.element = R(t.element)),
                            (E.lcp.size = t.size),
                            (E.lcp.url = t.url));
                };
            if (
                ...
                if (L)
                    ...
                    L &&
                        ...
                        ((L = (n = new URLSearchParams(L.replace(/^[^\?]+\??/, ""))).get(
                                "token"
                            )) && (h.token = L),
                            (L = n.get("spa")),
                            (h.spa = null === L || "true" === L));
                        ...
                        function n(e, t) {
                            ...
                            0 != t && (r.bypassTiming = !0),
                                ...
                                (1 === h.r && (r.resources = []),
                                    P &&
                                    0 === t &&
                                    (y.push({ id: r.pageloadId, url: r.location }),
                                        3 < y.length) &&
                                    y.shift(),
                                    i.sendObjectBeacon("", r, function() {}, !1, _),
                                    void 0 !== h.forward) &&
                    ...
                    (C = function(e) {
                        var t = (function() {
                            ...
                            try {
                                t = (
                                    "function" == typeof v.getEntriesByType ?
                                    new URL(v.getEntriesByType("navigation")[0].name) :
                                    b ?
                                    new URL(b) :
                                    window.location
                                ).pathname;
                            ...
                            return (
                                ...
                                E &&
                                ((t.lcp = (E.lcp && void 0 !== E.lcp.value ? E : t).lcp),
                                    (t.fid = (E.fid && void 0 !== E.fid.value ? E : t).fid),
                                    (t.cls = (E.cls && void 0 !== E.cls.value ? E : t).cls)),
                                h && (t.siteToken = h.token),
                                t
                            );
                        })();
                        e || ((t.resources = []), delete t.tempResources),
                            h && i.sendObjectBeacon("", t, function() {}, !0, _);
                    }),
                    (N = function() {
                        T = !0;
                        var e =
    ...
    function(e, t, n) {
        "use strict";
        (t.__esModule = !0),
        ((t = t.EventType || (t.EventType = {}))[(t.Load = 1)] = "Load"),
        ...
        (t.sendObjectBeacon = function(e, t, n, r, i) {
            ...
            if (navigator && "string" == typeof navigator.userAgent)
                try {
                    ...
                    c &&
                        -1 < c[0].toLowerCase().indexOf("chrome") &&
                        parseInt(c[1]) < 81 &&
                        (a = !1);
                } catch (e) {}
    ...
    function(e, t, n) {
        ...
        function p(t, n) {
            function e(e) {
                "first-contentful-paint" === e.name &&
                    (c && c.disconnect(), e.startTime < i.firstHiddenTime) &&
        ...
        function c(e, t) {
            g || ((g = t), (y = e), (r = new Date()), v(removeEventListener), m());
        }
        ...
        (t.getLCP = function(t, n) {
            ...
            c &&
                ((r = f(t, a, n)),
                    (i = function() {
                        R.has(a.id) ||
                            (c.takeRecords().map(e), c.disconnect(), R.add(a.id), r(!0));
